...
export async function fetchJiraStories(connection: JiraConnectionRequest): Promise<UserStory[]> {
  try {
    console.log('📝 Fetching Jira stories...', { baseUrl: connection.baseUrl, email: connection.email })
